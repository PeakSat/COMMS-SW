...
void RF_RXTask::execute() {
    ...
    read_reg = transceiver.spi_read_8(BBC0_PMUC, error);
    LOG_DEBUG << "BBC0_PMUC = " << read_reg;
    read_reg = transceiver.spi_read_8(BBC0_PMUVAL, error);
    LOG_DEBUG << "BBC0_PMUVAL = " << read_reg;
    read_reg = transceiver.spi_read_8(BBC0_PMUQF, error);
    LOG_DEBUG << "BBC0_PMUQF = " << read_reg;
    read_reg = transceiver.spi_read_8(BBC0_PMUI, error);
    LOG_DEBUG << "BBC0_PMUI = " << read_reg;
    read_reg = transceiver.spi_read_8(BBC0_PMUQ, error);
    LOG_DEBUG << "BBC0_PMUQ = " << read_reg;
    LOG_DEBUG << "#### Timestamp  ####";
    read_reg = transceiver.spi_read_8(BBC0_CNTC, error);
    LOG_DEBUG << "BBC0_CNTC = " << read_reg;
    read_reg = transceiver.spi_read_8(BBC0_CNT0, error);
    LOG_DEBUG << "BBC0_CNT0 = " << read_reg;
    read_reg = transceiver.spi_read_8(BBC0_CNT1, error);
    LOG_DEBUG << "BBC0_CNT1 = " << read_reg;
    read_reg = transceiver.spi_read_8(BBC0_CNT2, error);
    LOG_DEBUG << "BBC0_CNT2 = " << read_reg;
    read_reg = transceiver.spi_read_8(BBC0_CNT3, error);
